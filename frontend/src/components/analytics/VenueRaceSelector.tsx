    ...
    <div style={{ display: "flex", alignItems: "center", gap: 8, position: "relative", flexWrap: "wrap" }}>
      ...
      <div ref={venueRef} style={{ position: "relative" }}>
        ...
        >
          ...
          <span style={{ overflow: "hidden", textOverflow: "ellipsis", maxWidth: "min(38vw, 180px)" }}>{venueLabel}</span>
          <ChevronDown
            size={13}
            style={{
              color: "#94A3B8",
      ...
      {selectedVenue && (
        <div ref={raceRef} style={{ position: "relative" }}>
          ...
          >
            ...
            <span style={{ overflow: "hidden", textOverflow: "ellipsis", maxWidth: "min(46vw, 220px)" }}>{raceLabel}</span>
            <ChevronDown
              size={13}
              style={{
                color: "#94A3B8",
