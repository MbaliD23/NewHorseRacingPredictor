        ...
        <div className="mx-auto flex w-full max-w-[1600px] flex-col gap-6 px-2 sm:px-4 lg:px-6">
          ...
          <div className="rounded-[32px] border border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-[#131424]/90 px-4 py-4 shadow-[0_1px_8px_-4px_rgba(0,0,0,0.08)] sm:px-6 lg:px-8">
            ...
            <div className="mt-4 flex flex-col gap-2">
              ...
              <h1 className="text-[clamp(1.85rem,3.2vw,3.2rem)] font-black leading-[1.02] tracking-tight text-slate-950 dark:text-white">
                {venueTitle}
              </h1>
            </div>
          </div>
          ...
          <GlassCard className="group overflow-hidden rounded-[1.4rem] border-slate-100 dark:border-slate-800 bg-white dark:bg-[#131424]/90 text-slate-900 dark:text-white shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:ring-[2px] hover:ring-purple-600/60 hover:shadow-[0_12px_40px_rgba(106,45,241,0.12)]">
            <div className="relative h-40 overflow-hidden bg-slate-100 dark:bg-slate-800 sm:h-52">
              <img
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5 bg-white dark:bg-[#131424]/90 p-4 sm:p-5">
...
function InfoTile({
  ...
  return (
    <div className="rounded-2xl border border-slate-100 dark:border-slate-800/60 bg-slate-50/80 dark:bg-slate-900/60 p-3.5 sm:p-4">
      ...
      <p className="mt-0.5 text-base sm:text-lg font-black text-slate-950 dark:text-white">{value}</p>
    </div>
  );
}
