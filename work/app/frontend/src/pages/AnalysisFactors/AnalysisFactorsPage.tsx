...
import { BadgeDollarSign, BarChart3, Check, Goal, Info, Scale, Sparkles, Trophy, UserRound } from "lucide-react";
...
const factors: Array<{
  ...
  { code: "trainer_ranking", Icon: Trophy, centerAngle: 240, explanation: "Highlights the stable's recent edge, letting the strongest training yards carry more weight in the final prediction mix." },
  { code: "jockey_rating", Icon: UserRound, centerAngle: 300, explanation: "Uses the jockey form signal already exposed by the app data to surface stronger decision-making in the saddle." },
  ...
  { code: "starting_price", Icon: BadgeDollarSign, centerAngle: 180, explanation: "Lets the market price contribute to the final view without changing any underlying business logic or feed shape." },
];
