...
class HorseFormEntry(TimestampMixin, Base):
    ...
    weeks: Mapped[str | None] = mapped_column(String(20), nullable=True)
    track: Mapped[str | None] = mapped_column(String(30), nullable=True)
    going: Mapped[str | None] = mapped_column(String(20), nullable=True)
    race_class: Mapped[str | None] = mapped_column(String(50), nullable=True)
    course_desc: Mapped[str | None] = mapped_column(String(20), nullable=True)
    ...
    shoeing: Mapped[str | None] = mapped_column(String(20), nullable=True)
    ...
    adjusted_time: Mapped[str | None] = mapped_column(String(30), nullable=True)
    opening_bet: Mapped[str | None] = mapped_column(String(30), nullable=True)
    odds: Mapped[str | None] = mapped_column(String(30), nullable=True)
    starting_price: Mapped[str | None] = mapped_column(String(30), nullable=True)
    actual_rating: Mapped[str | None] = mapped_column(String(30), nullable=True)
    merit_rating: Mapped[str | None] = mapped_column(String(30), nullable=True)
