        ...
        return HorseView(
            ...
            form_entries=[
                HorseFormEntryView(
                    ...
                    odds=entry.odds,
                    starting_price=getattr(entry, "starting_price", None),
                    sp=getattr(entry, "starting_price", None),
                    actual_rating=entry.actual_rating,
                    pts=getattr(entry, "actual_rating", None) or getattr(entry, "pts", None),
                    merit_rating=getattr(entry, "merit_rating", None),
                    mr=getattr(entry, "merit_rating", None),
                    comment=entry.comment,
                    speed_figure=getattr(entry, "speed_figure", None) or entry.adjusted_time,
                    rating=entry.rating,
